<template>
  <footer class="border-t border-neutral-800 bg-neutral-900 py-16 md:py-20">
    <div class="max-w-5xl mx-auto px-6 lg:px-8">
      ...
      <div class="mb-12 pb-12 border-b border-neutral-800/80">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          ...
          <NuxtLink 
            to="/dashboard"
            class="inline-flex items-center gap-2 rounded-lg px-6 py-3 text-sm font-semibold text-neutral-900 bg-white hover:bg-neutral-100 transition-all duration-300 shadow-md hover:shadow-lg"
          >
            Get Started
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12">
        <!-- Products -->
        <div>
          <h4 class="text-sm font-semibold text-white mb-4 uppercase tracking-wider">Products</h4>
          <ul class="space-y-3">
            <li>
              <NuxtLink to="/website" class="text-sm text-neutral-300 hover:text-white transition-colors inline-flex items-center gap-1 group">
                <span>Websites</span>
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li>
              <NuxtLink to="/contact" class="text-sm text-neutral-300 hover:text-white transition-colors inline-flex items-center gap-1 group">
                <span>Contact</span>
                <svg class="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
                </svg>
            ...
            <li>
              <a href="#" class="text-sm text-neutral-300 hover:text-white transition-colors inline-flex items-center gap-1 group">
                <span>About</span>
                <svg class="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
                </svg>
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li>
              <NuxtLink to="/dashboard" class="text-sm text-neutral-300 hover:text-white transition-colors inline-flex items-center gap-1 group">
                <span>Pricing</span>
                <svg class="w-3 h-3 opacity-0 group-hover:opacity-100 transition-opacity" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M9 5l7 7-7 7" />
                </svg>
      ...
      <div class="pt-8 border-t border-neutral-800/80 flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-5">
          ...
          <a href="#" class="text-neutral-400 hover:text-white transition-all duration-300 hover:scale-110" aria-label="LinkedIn">
            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
              <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
            </svg>
          </a>
          <a href="#" class="text-neutral-400 hover:text-white transition-all duration-300 hover:scale-110" aria-label="GitHub">
            <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
