  ...
  <div class="min-h-[80vh] flex items-center justify-center px-4 py-16">
    <div class="w-full max-w-md space-y-8">
      <div class="text-center space-y-2">
        <h1 class="text-3xl font-bold tracking-tight text-neutral-900">Welcome back</h1>
        ...
        <form @submit.prevent="handleLogin" class="space-y-4">
          ...
          <div>
            <div class="flex items-center justify-between mb-2">
              ...
              <a href="#" class="text-xs text-neutral-600 hover:text-neutral-900">Forgot?</a>
            </div>
            <input
              id="password"
      ...
      <div class="text-center text-sm text-neutral-600">
        ...
        <NuxtLink to="/signup" class="text-neutral-900 font-semibold hover:underline">
          Sign up
        </NuxtLink>
      </div>
    </div>
