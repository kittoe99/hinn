  ...
  <div>
    ...
    <section class="py-20 md:py-32 bg-neutral-50">
      <div class="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid md:grid-cols-2 gap-6">
          <div v-for="(item, index) in aiFeatures" :key="item.title" :ref="el => { if (el) aiFeatureRefs[index] = el }" class="group border border-neutral-200 bg-white p-8">
            <div class="mb-4">
    ...
    <section class="py-20 md:py-32">
      <div class="max-w-5xl mx-auto px-6 lg:px-8">
        ...
        <div class="space-y-6">
          <div v-for="(feature, index) in automationFeatures" :key="feature.title" :ref="el => { if (el) autoFeatureRefs[index] = el }" class="group border border-neutral-200 bg-white p-8">
