            ...
            <div class="relative overflow-hidden bg-white border border-neutral-200 rounded-2xl mb-8">
              ...
              <div class="p-4 sm:p-6 md:p-8">
                <div class="flex flex-col md:flex-row items-start gap-8">
                  <!-- Site Preview -->
                  <div class="w-full md:w-[450px] lg:w-[500px] flex-shrink-0">
                    <div class="rounded-xl border border-neutral-200 overflow-hidden bg-white shadow-lg">
                      <div v-if="selectedWebsite.custom_domain || selectedWebsite.domain" class="relative bg-white group">
                        ...
                        <!-- Screenshot Preview -->
                        <div class="aspect-[16/10] relative bg-white">
                          <!-- Screenshot Image -->
                          <img
      ...
      <div v-else-if="!selectedWebsiteId && activeTab === 'overview'" class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <button 
            ...
            class="group relative overflow-hidden bg-white border border-neutral-200 rounded-xl p-6 hover:border-neutral-300 hover:shadow-md transition-all text-left cursor-pointer"
          >
            <div class="flex items-center justify-between mb-4">
              <div class="flex h-12 w-12 items-center justify-center rounded-xl bg-[#d97759]/10">
                <svg class="h-6 w-6 text-[#d97759]" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
            ...
            <div class="text-3xl font-semibold text-neutral-900 mb-1">Builder</div>
            <div class="text-sm font-medium text-neutral-600">Website Builder (Test)</div>
          </button>
        </div>
