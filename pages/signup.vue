<template>
  <div class="min-h-screen bg-white flex items-center justify-center px-6 py-12">
    <div class="w-full max-w-md border border-neutral-200 bg-white p-8 space-y-6">
      <div class="space-y-2">
      ...
      <div v-if="error" class="text-sm text-red-700 bg-red-50 border border-red-200 px-4 py-3">
        {{ error }}
      </div>
      <div v-if="success" class="text-sm text-green-700 bg-green-50 border border-green-200 px-4 py-3">
        {{ success }}
      </div>
      ...
      <button
        ...
        :disabled="loading"
        class="w-full inline-flex items-center justify-center gap-3 border border-neutral-300 px-4 py-3 bg-white hover:bg-neutral-50 disabled:opacity-60 transition-colors"
      >
      ...
      <form @submit.prevent="handleSignup" class="space-y-4">
        ...
        <button
          ...
          class="w-full bg-neutral-900 text-white px-4 py-3 text-base font-medium disabled:opacity-60 hover:bg-neutral-800 transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-900"
        >
