<template>
  <div class="min-h-screen bg-neutral-50">
    ...
    <main class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div class="relative overflow-hidden bg-white rounded-2xl border border-neutral-200 p-8">
        <div class="relative">
          ...
          <!-- Progress Indicator -->
          <div class="mb-8 rounded-3xl border border-neutral-200 bg-neutral-50 p-4 shadow-sm">
