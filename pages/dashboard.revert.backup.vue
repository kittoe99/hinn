                ...
                <div class="flex flex-col md:flex-row items-start gap-8">
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-4 flex-wrap mb-6">
                      ...
                      <span class="text-neutral-300">G헹</span>
                ...
                <div v-show="websiteExpandedSections.business" class="px-5 pb-5 border-t border-neutral-100">
                  <dl class="space-y-3 mt-4">
                    <div>
                      ...
                      <dd class="text-sm text-neutral-900">{{ selectedWebsiteOnboarding.business_name || 'G현' }}</dd>
                    </div>
                    <div>
                      <dt class="text-xs font-medium text-neutral-500 mb-1">Category</dt>
                      <dd class="text-sm text-neutral-900">{{ selectedWebsiteOnboarding.category || 'G현' }}</dd>
                    </div>
                ...
                <div v-show="websiteExpandedSections.contact" class="px-5 pb-5 border-t border-neutral-100">
                  <dl class="space-y-3 mt-4">
                    <div>
                      ...
                      <dd class="text-sm text-neutral-900">{{ selectedWebsiteOnboarding.contact_info.email || 'G현' }}</dd>
                    </div>
                    <div>
                      <dt class="text-xs font-medium text-neutral-500 mb-1">Phone</dt>
                      <dd class="text-sm text-neutral-900">{{ selectedWebsiteOnboarding.contact_info.phone || 'G현' }}</dd>
                    </div>
                ...
                <div v-show="websiteExpandedSections.serviceArea" class="px-5 pb-5 border-t border-neutral-100">
                  <dl class="space-y-3 mt-4">
                    <div>
                      ...
                      <dd class="text-sm text-neutral-900">{{ selectedWebsiteOnboarding.service_area.primary_location || 'G현' }}</dd>
                    </div>
                    <div>
                      <dt class="text-xs font-medium text-neutral-500 mb-1">Coverage Type</dt>
                      <dd class="text-sm text-neutral-900 capitalize">{{ selectedWebsiteOnboarding.service_area.coverage_type || 'G현' }}</dd>
                    </div>
                  </dl>
                </div>
              </section>
                ...
                <div v-show="websiteExpandedSections.operations" class="px-5 pb-5 border-t border-neutral-100">
                  <dl class="space-y-3 mt-4">
                    <div>
                      ...
                      <dd class="text-sm text-neutral-900 capitalize">{{ selectedWebsiteOnboarding.operation_details.on_site_mode || 'G현' }}</dd>
                    </div>
                    <div>
                      <dt class="text-xs font-medium text-neutral-500 mb-1">Business Hours</dt>
                      <dd class="text-sm text-neutral-900 capitalize">{{ selectedWebsiteOnboarding.operation_details.business_hours || 'G현' }}</dd>
                    </div>
                  </dl>
                </div>
              </section>
                ...
                <div v-show="websiteExpandedSections.websiteInfo" class="px-5 pb-5 border-t border-neutral-100">
                  <dl class="space-y-3 mt-4">
                    <div>
                      ...
                      <dd class="text-sm text-neutral-900">{{ selectedWebsiteOnboarding.website_info.primary_goal || 'G현' }}</dd>
                    </div>
          ...
          <div class="overflow-hidden  border border-neutral-200 bg-[#fefbf3]">
            ...
            >
              ...
              <div class="hidden md:flex self-center">
                ...
                <span v-else class="text-sm text-neutral-400">G현</span>
              </div>
                      ...
                      <tbody class="divide-y divide-neutral-200">
                        <tr v-for="domain in myDomains" :key="domain.id" class="hover:bg-[#fdf6e6] transition-colors">
                          ...
                          <td class="px-4 py-3">
                            ...
                            <span v-else class="inline-flex items-center px-2.5 py-0.5 text-xs border border-neutral-200 bg-neutral-100 text-neutral-700">G현</span>
                          </td>
                          <td class="px-4 py-3 text-neutral-800 hidden sm:table-cell">
                            {{ domain.price ? `${domain.currency || 'USD'} $${domain.price}${domain.period ? ` / ${domain.period} yr` : ''}` : 'G현' }}
                          </td>
                    ...
                    <tbody class="divide-y divide-neutral-200">
                      <tr v-for="domain in myDomains" :key="domain.id" class="hover:bg-[#fdf6e6] transition-colors">
                        ...
                        <td class="px-4 py-3">
                          ...
                          <span v-else class="inline-flex items-center border border-neutral-200 bg-neutral-100 px-2.5 py-0.5 text-xs text-neutral-700">G현</span>
                        </td>
                      ...
                      <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-neutral-200">
                          ...
                          >
                            ...
                            <td class="px-4 py-3 text-neutral-800">{{ suggestion.price != null ? `$${suggestion.price}` : 'G현' }}</td>
                            <td class="px-4 py-3 text-right">
                              <button
